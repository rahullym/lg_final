      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-slate-400 text-lg md:text-2xl max-w-3xl mx-auto leading-relaxed font-medium mb-8">
            Your passport to a global career. Earn STED Council credentials
            recognized by the Government of India, along with global
            certifications from prominent UK institutions like FICS UK.
          </p>
        </motion.div>
      </div>
