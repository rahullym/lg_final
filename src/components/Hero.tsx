...
const Hero = () => {
    return (
        <section className="relative min-h-screen w-full bg-[#050505] flex items-start overflow-hidden font-sans selection:bg-blue-500/30 pt-32 pb-20 md:pt-40 lg:pt-48 xl:pt-40 2xl:pt-48">
