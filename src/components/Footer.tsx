                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 items-start">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            <a id="footer-social-facebook" href="https://www.facebook.com/logisticsgurukulkochi/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white transition-all">
                            ...
                            <a id="footer-social-instagram" href="https://www.instagram.com/logisticsgurukul" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:bg-pink-600 hover:text-white transition-all">
                            ...
                            <a id="footer-social-youtube" href="https://www.youtube.com/@LogisticsGurukul2025" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:bg-red-600 hover:text-white transition-all">
                                <span className="sr-only">YouTube</span>
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>
                            </a>
                            <a id="footer-social-whatsapp" href="https://wa.me/917994446019" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:bg-green-600 hover:text-white transition-all">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3">
                            {[
                                { name: 'International Logistics & Freight Management', id: 'footer-course-diploma' },
                                { name: 'Supply Chain Management', id: 'footer-course-scm' },
                                { name: 'Import Export Management', id: 'footer-course-iem' },
                                { name: 'Warehouse Operations', id: 'footer-course-warehouse' }
                            ].map((course) => (
                                <li key={course.id} className="text-slate-300 text-sm hover:text-white transition-colors cursor-pointer">
                                    <a id={course.id} href="#">{course.name}</a>
                                </li>
                            ))}
                        </ul>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 text-slate-300 text-sm">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <a id="footer-lg-phone" href="tel:+917994446019" className="hover:text-white transition-colors">+91 79944 46019</a>
                            </div>
                            <div className="flex items-center gap-3">
                                <Mail className="w-5 h-5 text-blue-500 shrink-0" />
                                <a id="footer-lg-email" href="mailto:info@logisticsgurukul.com" className="hover:text-white transition-colors">info@logisticsgurukul.com</a>
                            </div>
                        </div>
                    </div>
